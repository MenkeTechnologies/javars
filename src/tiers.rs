...
//!
//! `java --tiers Main.java` prints the report.
...
pub struct ChunkTiers {
    /// Which chunk this is — `main` for a whole Java program.
    pub name: String,
...
/// has gone round enough times to be recorded. javars writes program output
